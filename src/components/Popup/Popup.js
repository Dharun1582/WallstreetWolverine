// popup for agreeing to rules and instructions when 'Register' button is clicked
...
const Popup = ({ funcToExec, checked, setChecked, isDisabled, setIsDisabled }) => {
            ...
            <div className={styles.lastbox}>
                ...
                <div className={styles.buttonContainer}>
                    <div style={{ width: '50%' }}>
                        ...
                        <button type={'submit'} disabled={isDisabled} className={styles.regButton} onClick={() => { navigate('/login') }}>Register</button>
                    </div>
...
// Popup exported to RegisterForm